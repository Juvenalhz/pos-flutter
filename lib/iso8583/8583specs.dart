...
var contentTypes1987 = new List<Map<String, dynamic>>.unmodifiable({
  ...
  {'field': 49, 'ContentType': 'n', 'MaxLen': 3, 'LenType': LT.FIXED, 'description': 'Currency code, transaction'},
  ...
  {'field': 54, 'ContentType': 'ans', 'MaxLen': 12, 'LenType': LT.FIXED, 'description': 'Additional amounts'},
