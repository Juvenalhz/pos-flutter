...
class IsoSpec1987 extends Iso8583Specs {
  ...
  IsoSpec1987() {
    ...
    ContentTypes1987.asMap().forEach((key, value) {
      IsoField temp = new IsoField(value['field'],  contentType: value['ContentType'],
          maxLength: value['MaxLen'], lengthType: value['LenType']);
      _addField(temp);
    });
  }
...
class IsoSpecASCII extends Iso8583Specs {
  ...
  IsoSpecASCII() {
    ...
    ContentTypes1987.asMap().forEach((key, value) {
      ...
      if (temp.lengthType != LT.FIXED)
        temp.lengthDataType = DT.ASCII;
