          ...
          body: TabBarView(
            children: [
              ...
              ListView(
                ...
                children: <Widget>[
                  ...
                  ItemTileTwoColumn(
                    ...
                    rightLabel: CheckboxItem(label: 'Clave Cierre', value: false, onChanged: null),
                    leftWidth: size.width / 2.18,
                    rightWidth: size.width / 2.18,
                  ),
                  ItemTileTwoColumn(
              ...
              ListView(
                padding: const EdgeInsets.fromLTRB(16, 10, 16, 10),
                children: <Widget>[
                  DataTile(myTitle: 'TPDU', value: '6000030000', type: tNumber),
                  ItemTileTwoColumn(
                    contentPadding: EdgeInsets.zero,
                    leftLabel: DataTile(
                  ...
                  ItemTileTwoColumn(
                    contentPadding: EdgeInsets.zero,
                    leftLabel: DataTile(myTitle: 'IP POS', value: '192.168.1.1', type: tNumber),
                    rightLabel: DataTile(myTitle: 'Puerto Host', value: '1500', type: tNumber),
                    leftWidth: size.width / 2.26,
                    rightWidth: size.width / 2.8,
                  ),
